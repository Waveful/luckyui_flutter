...
class _LuckyShowcaseState extends State<LuckyShowcase> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Overlay.of(context).insert(OverlayEntry(
      builder: (BuildContext context) => LuckyToastMessenger(),
    ));
  }
          ...
          children: [
            ListView(
              children: [
                ...
                if (_filtersController1.selectedIndex == 0) Padding(
                    ...
                    children: [
                      ...
                      const Column(
                        ...
                        children: [
                          ...
                          LuckyBody(
                            text: "Lucky UI is a design library that helps you build beautiful hyper-scalable apps.",
                          ),
                          SizedBox(height: spaceXs),
                          LuckySmallBody(
                            text: "Made with love by Lucky Pen",
                          ),
                        ],
                      ),
                    ],
                ...
                if (_filtersController1.selectedIndex == 1) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 2) const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(),
                      LuckySmallBody(
                        text: "We use the native OS font family: San Francisco (iOS) and Roboto (Android).",
                      ),
                    ],
                  ),
                ),
                if (_filtersController1.selectedIndex == 3) const Padding(
                  padding: EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      LuckyDivider(),
                      LuckySmallBody(
                        text: "We use HugeIcons Solid Rounded as our icon set.",
                      ),
                      LuckyHeading(
                        text: "Solid",
                        fontSize: textXl,
                ...
                if (_filtersController1.selectedIndex == 4) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 5) const Padding(
                  padding: EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 6) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 7) const Padding(
                  padding: EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      LuckyForm(
                        heading: "Username",
                        description: "Enter your username, so people can find you on Waveful!",
                        hintText: "@username",
                ...
                if (_filtersController1.selectedIndex == 8) const Padding(
                  padding: EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 9) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      LuckyTabBar(
                        ...
                        tabs: const [
                          LuckyTabData(label: "Explore"),
                          LuckyTabData(label: "For You", showRedDot: true, counter: 7),
                        ],
                      ),
                    ],
                  ),
                ),
                if (_filtersController1.selectedIndex == 10) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 11) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 12) const Padding(
                  padding: EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 13) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 14) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        onTap: () {
                          LuckyBottomSheet.show(
                            ...
                            children: [
                              ...
                              const LuckyBody(
                                text: "Get 10% of your friends earnings when they make their first purchase of Superlikes!",
                              ),
                ...
                if (_filtersController1.selectedIndex == 15) Padding(
                  padding: const EdgeInsets.symmetric(horizontal: spaceMd),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_filtersController1.selectedIndex == 16) Column(
                ...
                if (_filtersController1.selectedIndex == 17) Column(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.end,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  spacing: spaceMd,
                ...
                if (_filtersController1.selectedIndex == 18) Column(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.end,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  spacing: spaceMd,
              ...
              child:Row(
                ...
                children: [
                  ...
                  LuckySwitch(
                    ...
                    onChanged: (value) {
                      final ThemeMode newThemeMode = value ? ThemeMode.light : ThemeMode.dark;
